...
fn query_countries_html(ctx: &Context) -> anyhow::Result<()> {
    ...
    println!("<body>");
    println!(
        "<p>{} activities in {} countries.</p>",
        total_activities, total_countries
    );
    ...
    println!("<hr />");
    println!(
        "<p>Generated by <a href=\"https://github.com/vmiklos/vmexam/tree/master/strava-mirror\">strava-mirror</a></p>"
    );
    println!("</body>");
    println!("</html>");
